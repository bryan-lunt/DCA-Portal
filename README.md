...
the reason why it is not enough just to deploy `dca-portal.ear`. You also need to define the 
...
of XML commented out. Please search for `Uncommented this when deploying dca-portal` in the file and uncomment the
...
[http://127.0.0.1:8080/dca-portal](http://127.0.0.1:8080/dca-portal/)) with your web browser.
